...
class CPX688R : public CSensorInfo {
public:
	CPX688R()
	{
		ModelName = _T("PX688R");
		pDieInfo = new CDA3380;
#if defined(_PX688R_10000) || defined(_DEBUG) || defined(_PX688R)
		ModelVersion.insert(10000);//1.0 DA3380
#endif
#if defined(_PX688R_10100) || defined(_DEBUG) || defined(_PX688R)
		ModelVersion.insert(10100);//1.01 DA3380
#endif


#if defined(_DEBUG) || defined(_PX688R) || defined(_PX688R_10000) ||defined(_PX688R_10100)
