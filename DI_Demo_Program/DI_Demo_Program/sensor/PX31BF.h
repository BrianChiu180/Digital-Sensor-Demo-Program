...
class CPX31BF : public CSensorInfo {
public:
	CPX31BF() {
		ModelName = _T("PX31BF");
#if defined(_PX31BF) || defined(_DEBUG) || defined(_RD)
	...
	void Init(uint16_t version) {
		...
		case 10000: {
			...
			pDieDetail->DlgStyle[MODEL_2] = MODELLESS_LIST;
			pDieDetail->DlgName[MODEL_2] = _T("Register Table");
			...
			pRegTable = &pDieDetail->RegisterTable;
			{
				...
				pRegTable->RegInfo.at(0xF3).bEngMode = FALSE;
				{
					...
					{
						pCtrlDetail->CtrlType = CHECK_GROUP;
						pCtrlDetail->BitMapping[0] = _T("PorFen");
					}
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						...
						pCtrlDetail->NameMapping[0] = _T("Open Drain");
						pCtrlDetail->NameMapping[1] = _T("Push Pull");
					}
#endif
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						...
						pCtrlDetail->NameMapping[9] = _T("INT pin is ~Obj Output");
					}
				}

				//Sun Light Suppression
				{
					...
					{
						pCtrlDetail->CtrlType = CHECK_GROUP;
						pCtrlDetail->CtrlName = make_pair(_T("SunLight Suppression"), _T(""));
						pCtrlDetail->CtrlFunc = CTRLFUNC_SL_SUPPRESSION;
					}
				}
				//
				...
				pRegTable->RegInfo.at(0xFE).bEngMode = FALSE;
				{
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						pCtrlDetail->CtrlName = make_pair(_T("PsInt"), _T("PS"));
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						pCtrlDetail->CtrlName = make_pair(_T("IrInt"), _T("IrInt"));
						pCtrlDetail->CtrlType = LED;
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						pCtrlDetail->CtrlName = make_pair(_T("DataInt"), _T("DataInt"));
						pCtrlDetail->CtrlType = LED;
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						pCtrlDetail->CtrlName = make_pair(_T("PorInt"), _T("PorInt"));
						pCtrlDetail->CtrlType = LED;
				...
				{					
					DlgCheck.Init(MODEL_1, make_pair(BarNumCount++, 0));					
					ASSERT(DlgCheckSet.insert(DlgCheck).second);
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
				...
				pRegTable->RegInfo.at(0x0C).bEngMode = FALSE;
				{
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						pCtrlDetail->CtrlName = make_pair(_T("Amb"), _T("PS Amb Data"));
						pCtrlDetail->CtrlType = PROGRESSBAR;
				...
				pRegTable->RegInfo.at(0x61).bEngMode = FALSE;
				{
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						...
						pCtrlDetail->CtrlName = make_pair(_T("PS Pulse Width"), _T(""));
				...
				pRegTable->RegInfo.at(0x62).bEngMode = FALSE;
				{
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						pCtrlDetail->CtrlType = COMBO_GROUP;
						pCtrlDetail->CtrlFunc = CTRLFUNC_CALCULATE_POWER;
						pCtrlDetail->CtrlName = make_pair(_T("PS Pulse Count"), _T(""));
				...
				pRegTable->RegInfo.at(0x64).bEngMode = FALSE;
				{
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						...
						pCtrlDetail->CtrlFunc = CTRLFUNC_CALCULATE_POWER;
						pCtrlDetail->CtrlFunc |= CTRLFUNC_CHANGE_NAMEMAPPING;
						pCtrlDetail->CtrlName = make_pair(_T("Maximum Driving Current"), _T(""));
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						...
						for (uint8_t i = 1; i < 0x10; i++)
						{
							if (i == 1)
							{
								csTemp.Format(_T("%.1f mA, Default"), (i + 1) * 1.5);
								pCtrlDetail->NameMapping2[make_pair(i, 0)] = csTemp;
								csTemp.Format(_T("%d mA, Default"), (i + 1) * 10);
								pCtrlDetail->NameMapping2[make_pair(i, 1)] = csTemp;
								csTemp.Format(_T("%.3f mA, Default"), (i + 1) * 1.875);
								pCtrlDetail->NameMapping2[make_pair(i, 2)] = csTemp;
								csTemp.Format(_T("%.1f mA, Default"), (i + 1) * 12.5);
				...
				pRegTable->RegInfo.at(0x65).bEngMode = FALSE;
				{
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						...
						for (uint8_t i = 1; i < 16; i++)
						{
							if (i == 5)
							{
								csTemp.Format(_T("x%d, Default"), i);
								pCtrlDetail->NameMapping[i] = csTemp;
							}
							else
							{
				...
				pRegTable->RegInfo.at(0x66).bEngMode = FALSE;
				{
					...
					{
						pCtrlDetail->CtrlType = COMBO_GROUP;
						pCtrlDetail->CtrlName = make_pair(_T("PS Coarse Ambient DAC"), _T(""));
						pCtrlDetail->BitMapping[0] = _T("PsCoasAmb");
						pCtrlDetail->NameMapping[0] = _T("0 step, Default");
						for (uint8_t i = 1; i < 64; i++)
						{							
				...
				pRegTable->RegInfo.at(0x67).bEngMode = FALSE;
				{
					...
					{
						pCtrlDetail->CtrlType = COMBO_GROUP;
						pCtrlDetail->CtrlName = make_pair(_T("PS Coarse Crosstalk DAC"), _T(""));
				...
				pRegTable->RegInfo.at(0x68).bEngMode = FALSE;
				{
					...
					{
						pCtrlDetail->CtrlType = COMBO_GROUP;
						pCtrlDetail->CtrlName = make_pair(_T("PS Fine Crosstalk DAC"), _T(""));
				...
				pRegTable->RegInfo.at(0x6B).bEngMode = FALSE;
				{
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						...
						for (uint8_t i = 1; i < 0x10; i++)
						{
							if (i == 1)
							{
								csTemp.Format(_T("After %d Cycles, Default"), i);
								pCtrlDetail->NameMapping[i] = csTemp;
							}
							else
							{
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						pCtrlDetail->CtrlName = make_pair(_T("PsTurbo"), _T(""));
						pCtrlDetail->CtrlType = CHECK_GROUP;
						pCtrlDetail->BitMapping[0] = _T("PsTurbo");
					}
#endif // DEBUG
				...
				pRegTable->RegInfo.at(0x72).bEngMode = FALSE;
				{
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						pCtrlDetail->CtrlType = COMBO_GROUP;
						pCtrlDetail->CtrlFunc = CTRLFUNC_CALCULATE_POWER;
						pCtrlDetail->BitMapping[0] = _T("IrPuc");
						pCtrlDetail->NameMapping[0] = _T("1C, Default");
				...
				pRegTable->RegInfo.at(0x74).bEngMode = FALSE;
				{
					...
					{
						pCtrlDetail->CtrlType = COMBO_GROUP;
						pCtrlDetail->BitMapping[0] = _T("IrDrvDc");
						pCtrlDetail->NameMapping[0] = _T("Normally");
						pCtrlDetail->NameMapping[2] = _T("Driving DC");
					}
#endif // _RD
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						...
						pCtrlDetail->CtrlFunc = CTRLFUNC_CALCULATE_POWER;
						pCtrlDetail->CtrlFunc |= CTRLFUNC_CHANGE_NAMEMAPPING;
						pCtrlDetail->BitMapping[0] = _T("IrDrvMax");
						pCtrlDetail->NameMapping[0] = _T("24 mA");
						pCtrlDetail->NameMapping[1] = _T("160 mA, LED");
						pCtrlDetail->NameMapping[2] = _T("30 mA");
						pCtrlDetail->NameMapping[3] = _T("200 mA, LED");
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						pCtrlDetail->CtrlName = make_pair(_T("IR Driver Control"), _T(""));
						pCtrlDetail->CtrlType = COMBO_GROUP;
						pCtrlDetail->CtrlFunc = CTRLFUNC_CALCULATE_POWER;
						pCtrlDetail->BitMapping[0] = _T("IrDrv");
						pCtrlDetail->BitMapping[1] = _T("IrDrvMax");
						pCtrlDetail->NameMapping2[make_pair(0, 0)] = _T("Off");
						pCtrlDetail->NameMapping2[make_pair(0, 1)] = _T("Off");
						pCtrlDetail->NameMapping2[make_pair(0, 2)] = _T("Off");
						pCtrlDetail->NameMapping2[make_pair(0, 3)] = _T("Off");
				...
				pRegTable->RegInfo.at(0x75).bEngMode = FALSE;
				{
					...
					{
						pCtrlDetail->CtrlType = COMBO_GROUP;
						pCtrlDetail->BitMapping[0] = _T("IrCoasGain");
						pCtrlDetail->NameMapping[0] = _T("x1");
					...
					{
						pCtrlDetail->CtrlType = COMBO_GROUP;
						pCtrlDetail->BitMapping[0] = _T("IrFineGain");
						pCtrlDetail->NameMapping[0] = _T("x1");
						for (uint8_t i = 0; i < 16; i++)
						{
							if (i == 1)
				...
				pRegTable->RegInfo.at(0x76).bEngMode = FALSE;
				{
					...
					{
						pCtrlDetail->CtrlType = COMBO_GROUP;
						pCtrlDetail->BitMapping[0] = _T("IrCoasAmb");
						pCtrlDetail->NameMapping[0] = _T("0 step, Default");
						for (uint8_t i = 1; i < 64; i++)
						{
							csTemp.Format(_T("%d step"), i);
				...
				pRegTable->RegInfo.at(0x77).bEngMode = FALSE;
				{
					...
					{
						pCtrlDetail->CtrlType = COMBO_GROUP;
						pCtrlDetail->BitMapping[0] = _T("IrCoasCt");
						pCtrlDetail->NameMapping[0] = _T("0 step, Default");
						for (uint8_t i = 1; i < 64; i++)
						{
							csTemp.Format(_T("%d step"), i);
				...
				pRegTable->RegInfo.at(0x78).bEngMode = FALSE;
				{
					...
					{
						pCtrlDetail->CtrlType = COMBO_GROUP;
						pCtrlDetail->BitMapping[0] = _T("IrFineCt");
						pCtrlDetail->NameMapping[0] = _T("0 step, Default");
						for (uint8_t i = 1; i < 128; i++)
						{
							csTemp.Format(_T("%d step"), i);
			...
			pRegTable->BitDetail.at(_T("PsDrv")).DefaultVal.at(0) = 0x07;//12mA
			pRegTable->BitDetail.at(_T("PsPuc")).DefaultVal.at(0) = 0x01;
			pRegTable->BitDetail.at(_T("PsPuw")).DefaultVal.at(0) = 0x10;
			pRegTable->BitDetail.at(_T("PsCal")).DefaultVal.at(0) = 0x0000;
...
#ifdef _RD
			pReadTable->insert(CReadTable(0x0C, 4, LogDec)); // Ambient data at New PS function
#endif
			break;
		}
		}
