...
class CAP306E : public CSensorInfo {
public:
	CAP306E()
	{
		ModelName = _T("AP306E");
		pDieInfo = new CDA3221;
#if defined(_AP306E_13000) || defined(_DEBUG) || defined(_AP306E)
	...
	void Init(uint16_t version)
	{
		...
		case 13000: {
			...
			pRegTable = &pDieDetail->RegisterTable;
			{
				...
				pRegTable->RegInfo.at(0x10).bEngMode = FALSE;
				{
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						...
						pCtrlDetail->NameMapping[3] = _T("64X");
					}
				}
				...
				pRegTable->RegInfo.at(0x21).bEngMode = FALSE;
				{
					...
					pCtrlDetail = &pCtrlInfo[DlgCheck.DlgSel]->CtrlDetail[DlgCheck.CtrlXY];
					{
						...
						pCtrlDetail->NameMapping[0] = _T("100%");
						pCtrlDetail->NameMapping[1] = _T("66.7%");
						pCtrlDetail->NameMapping[2] = _T("33.3%");
					}
				}
			...
			pRegTable->BitDetail.at(_T("PS LED Driver")).DefaultVal.at(0) = 0x00;
