...
class CDA1990C : public CDieInfo {
public:
	CDA1990C() {}
	void Init(uint16_t version)
	{
		...
		case 10000:
			DieDetail.insert(make_pair(10000, CDieDetail()));
			{
				...
				pRegTable->SetRegInfo({ 0x00, 0x00 }, _T("AlsData3"), 2);
				{
					pRegTable->SetBitDetail2(_T("AlsData3"), _T("AlsData3"));
				}
				...
				{
					pRegTable->SetBitDetail(_T("AlsRev"), 3, _T("Color Gain type"));
					pRegTable->SetBitDetail(_T("AlsGain"), _T("Als Gain"), 0x07, 0, BOTH_RW, { 0, 0x07 });
				}
				...
				pRegTable->SetRegInfo({ 0x32 }, _T("AlsPuw1"));
				{
					pRegTable->SetBitDetail(_T("AlsPuw1"), _T("AlsData1 Conversion width"), 0x7F, 0, BOTH_RW, { 0, 0x7F }, 0x32);
				}

				pRegTable->SetRegAddr(0x57);
				pRegTable->SetRegInfo({ 0x32 }, _T("AlsPuw2"));
				{
					pRegTable->SetBitDetail(_T("AlsPuw2"), _T("AlsData2 Conversion width"), 0x7F, 0, BOTH_RW, { 0, 0x7F }, 0x32);
				}

				pRegTable->SetRegAddr(0x58);
				pRegTable->SetRegInfo({ 0x32 }, _T("AlsPuw3"));
				{
					pRegTable->SetBitDetail(_T("AlsPuw3"), _T("AlsData3 Conversion width"), 0x7F, 0, BOTH_RW, { 0, 0x7F }, 0x32);
				}

				pRegTable->SetRegAddr(0x5B);
				pRegTable->SetRegInfo({ 0x01 }, _T("AlsAlgoCtrl"));
				{
					pRegTable->SetBitDetail(_T("AlsIntSrc"), _T("Define the AlsData to assert AlsInt."), 0x30, 4, BOTH_RW, { 0, 0x03 });
				...
				//RD Mode
				{
					...
					{
						pRegTable->SetBitDetail(_T("TmpCap"), 1, _T("Control pin \"pcap_sel\" at TMP ADC"), 1);
					}
					...
					pRegTable->SetRegInfo({ 0x01 }, _T("DarkTrim"));
					{
						pRegTable->SetBitDetail(_T("DarkTrim"), _T("Control pin \"darktriml\""), 0x1F, 0, BOTH_RW, { 0, 0x1F }, 0x01);
					}
